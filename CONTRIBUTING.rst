...
1. Fork `the repository <https://github.com/augmentedfabricationlab/participative_fabrication>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/participative_fabrication/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/participative_fabrication/issues>`_. If you are proposing a feature:
